...
#python tasks/get_data_spice2.py --data-dir "/dfs9/dmobley-lab/openff-bts"
...
## Optimization
#python tasks/get_data_qca.py --datasets "OpenFF Cresset Additional Coverage Optimizations v4.0" \
#                             --dataset_type optimization \
#                             --data_file ./data/optimization

## Torsiondrive
#python tasks/get_data_qca.py --datasets "OpenFF Additional Generated Guanidine Amidine Derivative and O-Linker TorsionDrives 4.0" \
