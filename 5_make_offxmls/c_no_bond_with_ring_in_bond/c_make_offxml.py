...
SPECIFICITY_LEVELS_BY_COMPONENT: dict[
    ...
    Bond: {
        0: SpecificityLevel(
            ...
            get_atom_smirks=ffps.get_bond_smirks_standard,
            get_bond_smirks=ffps.get_bond_smirks_all_bonds_generalised_with_ring_info,
        ),
        1: SpecificityLevel(
            name="1:AtomAllAtom-BondGeneralized",
            get_atom_smirks=ffps.get_atom_smirks_all_bonded_atom,
            get_bond_smirks=ffps.get_bond_smirks_all_bonds_generalised_with_ring_info,
        ),
    },
    Angle: {
        0: SpecificityLevel(
            ...
            get_bond_smirks=ffps.get_bond_smirks_non_central_bonds_generalised_with_ring_info,
        ),
        1: SpecificityLevel(
        ...
        3: SpecificityLevel(
            ...
            get_atom_smirks=ffps.get_atom_smirks_central_all_bonded_atom,
            get_bond_smirks=ffps.get_bond_smirks_all_bonds_generalised_with_ring_info,
        ),
    },
}
