...
#SBATCH --job-name=aMakeInterchanges  ## job name
...
python a_make_offxml.py --data-dir "../../3_split_train_test/full_split_uci/data-train" \
                      --filename-offxml-in "../../forcefields/openff_unconstrained-2.3.0-rc1.offxml" \
