...
python ../fit_data.py --data-dir "../../3_split_train_test/full_split_uci/data-train" \
                      --filename-forcefield "../../4_setup_train_ff_topologies/2025_09_11_uci_full_split/smee_force_field.pkl" \
                      --filename-topo-dict "../../4_setup_train_ff_topologies/2025_09_11_uci_full_split/smee_topology_dict.pkl" \
                      --offxml "../../5_make_offxmls/a_broad_specification/openff-2.2.1-ring-no-bond.offxml" \
                      --n-epochs 1000 \
		      --to-cuda true \
