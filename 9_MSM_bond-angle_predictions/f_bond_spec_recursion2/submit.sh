...
#SBATCH --job-name=MSM-f  ## job name
...
python ../generate-msm-forcefield.py --input-forcefield ../../4_make_offxmls/f_broad_spec_recursion2/openff-2.3.0-bondangletypes-recursion2.offxml \
                                     --output-forcefield openff-ff-f-msm.offxml \
